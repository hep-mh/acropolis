...
This implies in particular that the initial abundances for photodisintegration correspond to the final abundances of BBN.\footnote{This factorization specifically implies that \acropolis can be used independently of the actual BBN code and therefore can easily be incorporated as a post-processing step into most existing tool chains.}
