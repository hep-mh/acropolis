...
# aot.cascade
try:
    cc = import_module(".cascade", package="acropolis.aot")
except ModuleNotFoundError:
    import acropolis.aot.pycc_cascade as cc
...
class _PhotonReactionWrapper(_ReactionWrapperScaffold):
    ...
    def _rate_pair_creation_ae(self, E, T):
        ...
        I_fso_E2 = dblquad(cc.ph_rate_pair_creation_ae, log(llim), log(ulim), \
    ...
    def _kernel_inverse_compton(self, E, Ep, T):
        ...
        I_fF_E = quad(cc.ph_kernel_inverse_compton, log(llim), log(ulim), epsrel=eps, epsabs=0, args=(E, Ep, T, me))
...
class _AbstractElectronReactionWrapper(_ReactionWrapperScaffold, metaclass=ABCMeta):
    ...
    def _rate_inverse_compton(self, E, T):
        ...
        I_fF_E = dblquad(cc.el_rate_inverse_compton, 0., ulim, lambda x: x, lambda x: 4.*x*E*E/( me2 + 4.*x*E ), epsrel=eps, epsabs=0, args=(E, T, me))
    ...
    def _kernel_inverse_compton(self, E, Ep, T):
        ...
        # Perform the integration in log space
        I_fF_E = quad(cc.el_kernel_inverse_compton, log(llim), log(ulim), epsrel=eps, epsabs=0, args=(E, Ep, T, me))
    ...
    def _kernel_bethe_heitler(self, E, Ep, T):
        ...
        return self._nNZ2(T)*cc.dsdE_Z2(E, Ep, me, re, alpha)
    ...
    def _kernel_pair_creation_ae(self, E, Ep, T):
        ...
        # Perform the integration in log space
        I_fG_E2 = quad(cc.el_kernel_pair_creation_ae, log(llim), log(ulim), epsrel=eps, epsabs=0, args=(E, Ep, T, me))
