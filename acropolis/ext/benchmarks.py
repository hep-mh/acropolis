...
# -->
BenchmarkModel1 = partial(ResonanceModel, nd = 0, S = 1  , tempkd = partial(estimate_tempkd_ee, sigma_ee_b1))
BenchmarkModel2 = partial(ResonanceModel, nd = 0, S = 3/4, tempkd = partial(estimate_tempkd_ee, sigma_ee_b2))
BenchmarkModel3 = partial(ResonanceModel, nd = 1, S = 3/2, tempkd = partial(estimate_tempkd_ee, sigma_ee_b3))